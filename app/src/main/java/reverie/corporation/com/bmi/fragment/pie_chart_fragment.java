...
/*    DatabaseHelpher helper;*/
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(getString(R.string.menu_pie_chart));
        ...
        BarDataSet dataset = new BarDataSet(entries, getString(R.string.menu_pie_chart));
